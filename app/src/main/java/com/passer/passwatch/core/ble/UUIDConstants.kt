...
enum class UUIDConstants(val uuid: UUID) {
    ...
    GPS_TIME(UUID.fromString("00002113-0000-1000-8000-00805F9B34FB")),
    ...
    // GoPro Status
    SERVICE_GOPRO(UUID.fromString("00002300-0000-1000-8000-00805F9B34FB")),
    GOPRO_STATUS(UUID.fromString("00002301-0000-1000-8000-00805F9B34FB")),
}
